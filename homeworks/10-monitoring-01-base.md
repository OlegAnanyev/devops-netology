...
```
Ошибка, видимо, в том, что при обращении к некоторым URL происходят редиректы, следовательно сервер отдаёт 3xx http-коды и их тоже нужно считать корректными в SLI. То есть правильнее будет рассчитывать SLI так:
